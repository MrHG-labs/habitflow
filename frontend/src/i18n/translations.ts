...
export const translations = {
  es: {
    ...
    achievements: {
      ...
      startWorking: 'Mantén tus rachas para evolucionar tu medalla hasta Diamante.',
      milestoneFlame: '¡Racha de {days} días!',
      milestoneBronze: 'Consistencia de {days} días',
      milestoneSilver: 'Dedicación de {days} días',
      milestoneGold: 'Maestría de 21 días (Hábito Formado)',
      milestonePlatinum: 'Dominio de 40 días (Constancia Pura)',
      milestoneDiamond: 'Leyenda de 60 días (Identidad)',
  ...
  en: {
    ...
    achievements: {
      ...
      startWorking: 'Keep your streaks to evolve your medal up to Diamond.',
      milestoneFlame: '{days}-Day Streak!',
      milestoneBronze: '{days}-Day Consistency',
      milestoneSilver: '{days}-Day Dedication',
      milestoneGold: '21-Day Mastery (Habit Formed)',
      milestonePlatinum: '40-Day Mastery (Pure Consistency)',
      milestoneDiamond: '60-Day Legend (Identity)',
